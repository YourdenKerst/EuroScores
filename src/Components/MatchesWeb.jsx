...
const Matches = () => {
  ...
  return (
    <div className='h-screen border-b-2 border-white flex flex-row justify-center'>
      <div className="h-full w-[25%] flex items-center justify-center align-middle respon4:w-[30%]">
        <div className="h-3/4 w-[75%] mt-20 text-white">

          <div className="w-[100%] h-[45%] bg-donkerblauw containermatches flex flex-col align-middle items-center">
            <div className="h-[25%] flex items-center justify-center align-middle">
          ...
          {topScorer && (
            <div className="w-[100%] h-[45%] bg-donkerblauw containermatches flex items-center justify-center align-middle flex-col">
              <h2 className='titelmtch'>TOPSCORER</h2>
              <div className="circle-border">
                <img src={topScorer.player.photo} alt="Player Image" />
              </div>
              <p className='naammtch'>{topScorer.player.name}</p>
              <p className='scoremtch'>GOALS: {topScorer.statistics[0].goals.total}</p>
            </div>
          )}
        </div>
      </div>
      ...
      <div className="h-full w-[25%] flex items-center justify-center align-middle respon4:w-[30%]">
        <div className="containermatches h-3/4 bg-donkerblauw w-[100%] rounded-lg mt-20 p-6 text-white">
      ...
      <div className="h-full w-[25%] flex items-center justify-center align-middle respon4:w-[30%]">
        <div className="h-3/4 w-[75%] mt-20 text-white">
          <div className="w-[100%] h-[45%] bg-donkerblauw containermatches">
          ...
          {topAssister && (
            <div className="w-[100%] h-[45%] bg-donkerblauw containermatches flex items-center justify-center align-middle flex-col">
              <h2 className='titelmtch'>TOP ASSISTER</h2>
              <div className="circle-border">
                <img src={topAssister.player.photo} alt="Player Image" />
              </div>
              <p className='naammtch'>{topAssister.player.name}</p>
              <p className='scoremtch'>ASSISTS: {topAssister.statistics[0].goals.assists}</p>
            </div>
          )}
        </div>
      </div>
