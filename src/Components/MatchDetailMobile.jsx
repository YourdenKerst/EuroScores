...
const MatchDetail = () => {
      ...
      try {
        const response = await fetch(`https://v3.football.api-sports.io/fixtures?id=${id}`, {
          ...
          headers: {
            ...
            "x-rapidapi-key": "xxxxxxxx" // Replace with your own API key
          }
        });
  ...
  return (
    <div className="h-auto border-b-2 border-white flex flex-col">
      <div className="w-full h-full flex align-middle items-center justify-center">
        <div className="containermatches h-[650px] bg-donkerblauw w-[45vw] respon6:w-[55vw] respon9:w-[75vw] respon10:w-[90vw] flex items-center flex-col rounded-lg mt-32 p-6 text-white">
      ...
      <div className="w-full h-full flex justify-center mb-12">
        <div className="containermatches h-[220px] w-[45vw] respon6:w-[55vw] respon9:w-[75vw] respon10:w-[90vw] rounded-lg mt-20 text-white">

          <div className="h-[100%] bg-donkerblauw p-6 rounded-lg containermatches text-white">
