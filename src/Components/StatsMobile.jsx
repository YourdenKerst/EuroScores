...
const StatsMobile = () => {
      ...
      try {
        const response = await fetch(`https://v3.football.api-sports.io/standings?league=4&season=2024`, {
          ...
          headers: {
            ...
            "x-rapidapi-key": "xxxxxxxxxxxxxx" // Replace with your own API key
          }
        });
  ...
  return (
    <div className='border-b-2 border-white flex flex-col items-center maincontgroep'>
      <div className="containergroep w-[70vw] respon7:w-[90vw] flex flex-col">
        {groups.map((group, groupIndex) => (
          <div key={groupIndex} className="w-full bg-donkerblauw p-6 containermatches text-white group groottecard">
            ...
            <div className="h-5 border-b-2 border-lichtblauw mb-2 flex flex-row pb-2">
              ...
              <div className="w-[65%] flex items-center respon8:ml-2">
                <p>Team</p>
              </div>
              <div className="w-[5%] flex items-center justify-center respon8:w-[10%]">
                <p>P</p>
              </div>
              <div className="w-[5%] flex items-center justify-center respon8:w-[10%]">
                <p>W</p>
              ...
              <div className="doelsaldo w-[5%] flex items-center justify-center">
                <p>GD</p>
              </div>
              <div className="w-[10%] flex items-center justify-center respon7:w-[20%]">
                <p>Points</p>
              </div>
            </div>
      ...
      <div className="containergroep w-[70vw] respon7:w-[90vw] flex items-end flex-col">
       <div className="w-[100%] bg-donkerblauw p-6 containermatches text-white group groottecard">
          ...
          {topYellowCards.map((player, index) => (
            <div key={player.player.id} className="text-white flex flex-row h-11 border-b border-white">
              ...
              <div className="w-[20%] flex items-center justify-center">
                ...
                <div className="w-[100%] rodekaart bg-donkerblauw p-6 containermatches text-white group groottecard">
